    ...
    <>
      <header className="bg-success text-white py-3 shadow sticky-top">
        <div className="container">
          <div className="d-flex justify-content-between align-items-center">
            {/* LOGO */}
            <Link href="/dokter" className="d-flex align-items-center text-decoration-none text-white">
              <div className="me-3">
            ...
            <nav className="d-none d-lg-flex align-items-center">
              {/* TOMBOL PENGAJUAN IZIN (DESKTOP) */}
              <Link href="/dashboarddokter/izin" className="btn btn-outline-light rounded-pill me-3 border-2 fw-bold px-4 shadow-sm">
                <i className="fas fa-file-medical me-2"></i>Pengajuan Izin
              </Link>
      ...
      {mobileMenuOpen && (
        <div className="bg-white border-bottom d-lg-none p-3 shadow-sm">
          ...
          {/* TOMBOL PENGAJUAN IZIN (MOBILE) */}
          <Link 
            href="/dashboarddokter/izin" 
            className="btn btn-success w-100 mb-2 text-start d-flex justify-content-between align-items-center"
            onClick={() => setMobileMenuOpen(false)}
          >
            <span><i className="fas fa-file-medical me-2"></i>Pengajuan Izin</span>
