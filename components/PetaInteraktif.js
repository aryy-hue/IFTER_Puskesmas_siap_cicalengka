...
// ==========================
// KOMPONEN LAPORAN ITEM (DIPISAHKAN UNTUK HINDARI HOOKS DI DALAM LOOP)
// ==========================
function LaporanItem({ 
  ...
  // Helper function untuk format rating dengan aman
  ...
  useEffect(() => {
    const loadItemReviews = async () => {
      try {
        ...
        // Gunakan endpoint public yang sudah bisa diakses tanpa token
    ...
    <div className="col-12">
      <div className="card border-secondary border-start border-4 shadow-sm">
        <div className="card-body">
          ...
          {/* SECTION REVIEW/KOMENTAR - MODIFIED FOR GUEST */}
...
export default function PetaInteraktif() {
  ...
  // Komponen Rating Stars untuk form
              ...
              <div className="modal-content">
                  ...
                  <h5 className="modal-title">
                    ...
                    {reviewStats.total_reviews > 0 && (
                      <span className="badge bg-warning text-dark ms-2">
                        ⭐ {formatAverageRating(reviewStats.average_rating)} ({reviewStats.total_reviews})
                      </span>
                    )}
                  </h5>
                  <button
                    ...
                    <>
                      ...
                      {!user && (
                        <div className="alert alert-info mb-4">
                          <i className="bi bi-info-circle me-2"></i>
                          <strong>Info:</strong> Anda sedang melihat sebagai tamu. 
                          <a href="/login" className="alert-link ms-1">Login</a> untuk memberikan komentar.
                        </div>
                      )}
                      ...
                      {user ? (
                        <div className="mb-4 p-3 border rounded">
                          <h6 className="mb-3">
                            {userReview ? 'Edit Komentar Anda' : 'Tambah Komentar Baru'}
                          </h6>
                          <div className="mb-3">
                      ...
                      {reviews.length > 0 ? (
                        <div>
                          <h6 className="mb-3">Semua Komentar ({reviews.length})</h6>
                          {reviews.map((review) => (
                            <div key={review.id} className="card mb-3">
                              <div className="card-body">
                                ...
                                <p className="mb-0">{review.pesan}</p>
                              </div>
                            </div>
                          ))}
                        </div>
                        ...
                        <div className="text-center py-5">
                          ...
                          <p className="mt-3 text-muted">
                            ...
                            {user && " Jadilah yang pertama berkomentar!"}
                          </p>
                        </div>
                      )}
                    </>
                ...
                <div className="modal-footer">
                  ...
                  {user && (
                    ...
                    >
                      {userReview ? 'Update Komentar' : 'Kirim Komentar'}
                    </button>
                  )}
                </div>
              </div>
